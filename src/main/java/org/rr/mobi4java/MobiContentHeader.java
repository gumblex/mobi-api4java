...
public class MobiContentHeader extends MobiContent {
    ...
    static MobiContentHeader readMobiHeader(byte[] content, long recordDataOffset, long recordDataLength)
            throws IOException {
    ...
    /**
     * @param firstNonBookIndex First record number (starting with 0) that's not the book's text.
     *                          Also excluding the book's index.
     */
    ...
    /**
     * @return The number of PDB records used for the text of the book.
     * This is necessarily the same number of mobi content entries containing text.
     */
    ...
    /**
     * @param recordCount The number of PDB records used for the text of the book.
     *                    This is necessarily the same number of mobi content entries
     *                    containing text.
     */
