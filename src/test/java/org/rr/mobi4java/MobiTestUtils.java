...
public class MobiTestUtils {
    ...
    private static byte[] getImageBytes(final BufferedImage image, String mime) throws IOException {
        ...
        while (imageWritersByFormatName.hasNext()) {
            ...
            if (writer == null && next.getClass().getName().
                    equals("com.sun.media.imageioimpl.plugins.jpeg.CLibJPEGImageWriter")) {
                writer = next;
                break;
            } else {
                writer = next;
    ...
    public static InputStream getStreamByUrl(String url) throws IOException {
